...
def main(args):
    ...
    table_name = f'02_vlb_{checkpoint_name}_{args.retrieval_k}_dropout{args.dropout}_{args.retrieval_dataset}_T={args.n_steps}_n={args.n_samples}_seed={args.sampling_seed}.csv'
    ...
    for i, data in enumerate(tqdm(dataloader)):
        ...
        for true_mol, product_mol, pred_mols, pred_scores, nlls, ells in zip(
            ...
            for pred_mol, pred_score, nll, ell in zip(pred_mols, pred_scores, nlls, ells):
                ...
                pred_validity = is_sanitized(pred_mol)
                ...
                is_validity.append(pred_validity)
